...
var Animator = class {
  ...
  enable() {
    ...
    Main.uiGroup.insert_child_below(this._background, this._iconsContainer);
  ...
  _animate() {
    ...
    if (!nearestIcon) {
      animateIcons.forEach((i) => {
        i._container.width = icon_spacing;
      });
    }
    ...
    animateIcons.forEach((icon) => {
      ...
      icon._container.width = icon_spacing * scale;
